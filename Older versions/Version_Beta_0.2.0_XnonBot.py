...
@bot.tree.command(name="help", description="Send a list of available slash commands.")
...
@bot.tree.command(name="waifu", description="Get a random waifu picture.")
...
async def on_message(message):
    def check_message(initial_requests):
        return (
            ...
            and initial_requests.channel == message.channel
